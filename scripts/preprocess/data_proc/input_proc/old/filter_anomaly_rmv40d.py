...
data_store = '/pscratch/sd/l/linyaoly/ERA5/reanalysis/fltano40/'
# ================================================
...
def compute_parallel(varn, data_path):
    ...
    flt_ano = rmv_runavg(target_ano, window_size=40)  # remove the previous 40-day running averages
    ...
    dataset.to_netcdf(data_store + varn +'.fltano40.' + year_sta + 'to' + year_end + 'based' + str(yearclim_sta) + 'to' + str(yearclim_end) + '.nc', mode='w')
