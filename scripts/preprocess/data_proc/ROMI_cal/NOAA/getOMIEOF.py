...
olr_data_filename = '/pscratch/sd/l/linyaoly/MJO_data_2.5x2.5/NOAA/olr.day.mean.nc'
...
# # Note: If you have set up the test suite using the reference data package (https://doi.org/10.5281/zenodo.3746562) and
# # if you have kept the original directory structure, the following default setting should directly work.
# originalOMIDataDirname = '/pscratch/sd/l/linyaoly/MJO_data_2.5x2.5/NOAA/ROMI/EOF'
...
# # Note: If you have set up the test suite using the reference data package (https://doi.org/10.5281/zenodo.3746562) and
# # if you have kept the original directory structure, the following default setting should directly work.
# originalOMIPCFile = '/pscratch/sd/l/linyaoly/MJO_data_2.5x2.5/NOAA/ROMI/PC/omi.txt'

# Files in which the results are saved. Adjust according to your system.

# The EOFs
eofnpzfile = '/pscratch/sd/l/linyaoly/MJO_data_2.5x2.5/NOAA/ROMI/EOFs.npz'
