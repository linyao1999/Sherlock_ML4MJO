...
def get_olr4omi(olrDataFile):
    ...
    x = get_anomalies_1var('olr', olrDataFile, None, None, latsel=20, yearclim_sta=1979, yearclim_end=2012)  
    x = x.drop('dayofyear')
    ...
    return olr_rt_noac_sm_tapavg, ttime, lons, lats
