...
fnolr = f'/pscratch/sd/l/linyaoly/ML_MJO_2024_redo/scripts/data_proc/RMM_cal/WH04_reproduce/olr.fltano120.{year_sta}to{year_end}based{yearclim_sta}to{yearclim_end}.nc'
fnu850 = f'/pscratch/sd/l/linyaoly/ML_MJO_2024_redo/scripts/data_proc/RMM_cal/WH04_reproduce/u850.fltano120.{year_sta}to{year_end}based{yearclim_sta}to{yearclim_end}.nc'
fnu200 = f'/pscratch/sd/l/linyaoly/ML_MJO_2024_redo/scripts/data_proc/RMM_cal/WH04_reproduce/u200.fltano120.{year_sta}to{year_end}based{yearclim_sta}to{yearclim_end}.nc'
...
get_RMMEOF(fnolr=fnolr, fnu200=fnu200, fnu850=fnu850, eof_sta=str(yearclim_sta)+'-01-01',eof_end=str(yearclim_end)+'-12-31', eof_lat=eof_lat)
...
get_RMM(RMM_field, EOF_RMM_field1, str(yearclim_sta)+'-01-01',str(yearclim_end)+'-12-31')