...
fnolr = f'/pscratch/sd/l/linyaoly/ML_MJO_2024_redo/data/fltano120/olr.fltano120.{year_sta}to{year_end}based{yearclim_sta}to{yearclim_end}.nc'
fnu850 = f'/pscratch/sd/l/linyaoly/ML_MJO_2024_redo/data/fltano120/u850.fltano120.{year_sta}to{year_end}based{yearclim_sta}to{yearclim_end}.nc'
fnu200 = f'/pscratch/sd/l/linyaoly/ML_MJO_2024_redo/data/fltano120/u200.fltano120.{year_sta}to{year_end}based{yearclim_sta}to{yearclim_end}.nc'

# daily data is stored in this directory.
dirn = '/pscratch/sd/l/linyaoly/ML_MJO_2024_redo/data/fltano120/'
