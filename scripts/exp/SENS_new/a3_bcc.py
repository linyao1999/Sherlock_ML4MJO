...
input_dir = os.environ.get("expflg", "unscaled_m10all_wnx1off")
# input_dir = os.environ.get("expflg", "unscaled_m10all_wnx9all_lat40")
...
for trial_rank in TOP_TRIALS:
    ...
    for period_name, dates in PERIODS.items():
        if rule != 'Iamp>1.0':
            out_file = save_dir / f"metrics_sens_{exp_name}_{trial_tag}_{period_name}_{rule}.npz"
        else:
            out_file = save_dir / f"metrics_sens_{exp_name}_{trial_tag}_{period_name}.npz"
...
if multi_lead:
    ...
    for period_name in PERIODS.keys():
        ...
        for i, trial in enumerate(TOP_TRIALS):
            data_path = save_dir / f"metrics_sens_{exp_name}_t{trial}_{period_name}.npz"
        ...
        bcc_save_path = save_dir / f"plot_sens_bcc_comparison_{exp_name}_{period_name}.png"
        ...
        rmse_save_path = save_dir / f"plot_sens_rmse_comparison_{exp_name}_{period_name}.png"
