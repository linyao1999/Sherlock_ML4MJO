...
max_lead = int(os.environ.get("max_lead", 25)) # Used for concatenating single leads
...
groups = {
    ...
    # "Unscaled_Group": [
    #     'fltano120_lat40', 
    #     'unscaled_m10all_wnx1off_lat40', 
    #     'unscaled_m10all_wnx9all_lat40', 
    #     'unscaled_m10resi_wnx9resi_lat40'
    # ],
    "Unscaled_Group": [
        'fltano120', 
    ...
    for period_name in PERIODS:
        ...
        for i, expflg in enumerate(expflg_list):
            ...
            if multi_lead:
                ...
                if rule != 'Iamp>1.0':
                    data_path = metrics_base_dir / exp_name / f"metrics_sens_{exp_name}_{trial_tag}_{period_name}_{rule}.npz"
                else:
                ...
                for l in range(max_lead + 1):
                    ...
                    if rule != 'Iamp>1.0':
                        data_path = metrics_base_dir / exp_name_lead / f"metrics_sens_{exp_name_lead}_{trial_tag}_{period_name}_{rule}.npz"
                    else:
                        data_path = metrics_base_dir / exp_name_lead / f"metrics_sens_{exp_name_lead}_{trial_tag}_{period_name}.npz"
        ...
        if multi_lead:
            if rule != 'Iamp>1.0':
                bcc_save_path = save_dir / f"plot_sens_bcc_{dataflg}_{input_var_name}_{model_name}_{output_var_name}_{group_name}_{period_name}_{rule}_multi.png"
            else:
                bcc_save_path = save_dir / f"plot_sens_bcc_{dataflg}_{input_var_name}_{model_name}_{output_var_name}_{group_name}_{period_name}_multi.png"
        else:
            if rule != 'Iamp>1.0':
                bcc_save_path = save_dir / f"plot_sens_bcc_{dataflg}_{input_var_name}_{model_name}_{output_var_name}_{group_name}_{period_name}_{rule}_single.png"
            else:
                bcc_save_path = save_dir / f"plot_sens_bcc_{dataflg}_{input_var_name}_{model_name}_{output_var_name}_{group_name}_{period_name}_single.png"
        ...
        if multi_lead:
            if rule != 'Iamp>1.0':
                rmse_save_path = save_dir / f"plot_sens_rmse_{dataflg}_{input_var_name}_{model_name}_{output_var_name}_{group_name}_{period_name}_{rule}_multi.png"
            else:
                rmse_save_path = save_dir / f"plot_sens_rmse_{dataflg}_{input_var_name}_{model_name}_{output_var_name}_{group_name}_{period_name}_multi.png"
        else:
            if rule != 'Iamp>1.0':
                rmse_save_path = save_dir / f"plot_sens_rmse_{dataflg}_{input_var_name}_{model_name}_{output_var_name}_{group_name}_{period_name}_{rule}_single.png"
            else:
                rmse_save_path = save_dir / f"plot_sens_rmse_{dataflg}_{input_var_name}_{model_name}_{output_var_name}_{group_name}_{period_name}_single.png"
