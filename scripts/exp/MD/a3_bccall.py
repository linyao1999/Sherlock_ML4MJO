...
input_var_name = os.environ.get("input_var", "u850")
...
groups = {
    ...
    #     'unscaled_m10all_wnx9all', 
    #     'unscaled_m10resi_wnx9resi',
    #     'unscaled_m1off_wnx9resi',
    #     'unscaled_m10all_wnx9resi',
    # ]
}
...
save_dir = Path("/scratch/users/linyao/ML4MJO/scripts/outputs/Figs/rescaled")
...
for group_name, expflg_list in groups.items():
    ...
    for period_name in PERIODS:
        ...
        if multi_lead:
            if rule != 'Iamp>1.0':
                bcc_save_path = save_dir / f"plot_bcc_{dataflg}_{input_var_name}_{model_name}_{output_var_name}_{group_name}_{period_name}_{rule}_multi.png"
            else:
            ...
            if rule != 'Iamp>1.0':
                bcc_save_path = save_dir / f"plot_bcc_{dataflg}_{input_var_name}_{model_name}_{output_var_name}_{group_name}_{period_name}_{rule}_single.png"
            else:
        ...
        if multi_lead:
            if rule != 'Iamp>1.0':
                rmse_save_path = save_dir / f"plot_rmse_{dataflg}_{input_var_name}_{model_name}_{output_var_name}_{group_name}_{period_name}_{rule}_multi.png"
            else:
                rmse_save_path = save_dir / f"plot_rmse_{dataflg}_{input_var_name}_{model_name}_{output_var_name}_{group_name}_{period_name}_multi.png"
        else:
            if rule != 'Iamp>1.0':
                rmse_save_path = save_dir / f"plot_rmse_{dataflg}_{input_var_name}_{model_name}_{output_var_name}_{group_name}_{period_name}_{rule}_single.png"
            else:
                rmse_save_path = save_dir / f"plot_rmse_{dataflg}_{input_var_name}_{model_name}_{output_var_name}_{group_name}_{period_name}_single.png"
